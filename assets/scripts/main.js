...
function initFormHandler() {
	...
	let formEl = document.querySelector('#new-recipe');
	// B3. TODO - Add an event listener for the 'submit' event, which fires when the
	//            submit button is clicked
	formEl.addEventListener('submit', (newEvent) =>{
	...
	//            values from the FormData object and insert them into recipeObject
		let recipeObject = {};
		formData.forEach((eachValue, eachKey) =>{
			recipeObject[eachKey] = eachValue;
		});
	...
	let pushButton = document.querySelector('button.danger');
